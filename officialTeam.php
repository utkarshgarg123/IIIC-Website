		...
		<div class="container">
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header">
					...
					<div class="nav-brand"><a class="navbar-brand" href="index.php"><img src="images/iiic2.png" width="40" height="40" alt=""></a></div>
				</div>
</body>
	...
	<div class="container-fluid" style="margin-top: 100px">
		<div class="row">
			<div class="col-md-12 section-heading text-center">
				<h2 class="to-animate">Offcial Team</h2>
				<div class="row">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="fh5co-person text-center to-animate">
					<figure><img src="images/speakers/directorsir.jpg" alt="Image"></figure>
